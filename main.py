...
from cdrl.pytorch.NNet import NNetWrapper as nn
from utils import *
...
args = dotdict({
    ...
    'tempThreshold': 15,        # Number of moves for which the temperature is 1.
    ...
    'cpuct': 2,                 # controls the amount of exploration
...
def main():
    log.info('Loading %s...', CdrlGame.__name__)
    g = CdrlGame()
